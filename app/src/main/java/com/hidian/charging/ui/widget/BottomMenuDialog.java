package com.hidian.charging.ui.widget;
...
public class BottomMenuDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder addMenus(List<String> texts,View.OnClickListener listener){
            for (int i = 0;i <texts.size();i++){
                BottomMenu bm = new BottomMenu(texts.get(i), listener);
                this.p.menuList.add(bm);
            }
